    ...
    private function getDefaultRoles(): array
    {
        return [
            ...
            'role_finance' => new Role('role_finance', 'Finanzen', [
                'privacy.finance.view', 'privacy.emails.view', 'permits.print',
                'dashboard.view',
                'finance.view', 'permits.suspend', 'finance.mark_paid',
                'permits.view',
                'stats.charts', 'stats.view', 'stats.ranking',
                'finance.export',
                'vouchers.suspend', 'vouchers.delete', 'vouchers.view',
                'dashboard.generator-tools.view',
                'permits.create',
            ...
            'role_support' => new Role('role_support', 'Sachbearbeitung', [
                'privacy.emails.view', 'permits.print', 'dashboard.view',
                'finance.view',
                'permits.view',
                'vouchers.view', 'vouchers.suspend', 'dashboard.generator-tools.view',
                'permits.create',
                'vouchers.create',
