    ...
    private function getDefaultRoles(): array
    {
        return [
            ...
            'role_finance' => new Role('role_finance', 'Finanzen', [
                'privacy.finance.view', 'privacy.emails.view', 'permits.print', 'dashboard.view',
                'finance.view', 'permits.suspend', 'finance.mark_paid', 'permits.view',
                'stats.charts', 'stats.view', 'stats.ranking', 'finance.export',
                'vouchers.suspend', 'vouchers.delete', 'vouchers.view', 'permits.create',
                'vouchers.create', 'template.manage', 'template.std_7',
            ...
            'role_support' => new Role('role_support', 'Sachbearbeitung', [
                'privacy.emails.view', 'permits.print', 'dashboard.view', 'finance.view', 'permits.view',
                'vouchers.view', 'vouchers.suspend', 'permits.create', 'vouchers.create',
                'system.logs.view', 'template.manage', 'template.std_7', 'template.std_14', 'template.std_30',
