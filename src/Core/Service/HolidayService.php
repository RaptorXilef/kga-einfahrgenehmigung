...
final readonly class HolidayService
{
    ...
    /**
     * Darf das Auto JETZT einfahren? Wichtigste Kontrollfrage
     *
    ...
    /**
     * Prüft generelle Sonn-/Feiertagssperren
     *
    ...
    /**
     * Liefert den Ausweichzeitraum, falls aktuell gesperrt
     *
    ...
    // --- Public UI & Document Text Formatters ---

    /**
     * Text für die heutige Anzeige
     *
    ...
    /**
     * HTML-Textblock für das PDF/A4-Dokument
     *
    ...
    /**
     * Listet die blockierten Feiertage im Dokument auf
     *
    ...
    /**
     * Berechnung nach Bundesland via Gauß
     *
    ...
    /**
     * Komprimiert Datums-Listen zu "von-bis"-Texten
     *
