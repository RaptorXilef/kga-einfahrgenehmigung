...
* **pwa:** Dynamically inject package.json version into Service Worker via PHP ([54916a2](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/54916a2e7292ee33eb2bc8f5e303816ffd0904aa))
* **pwa:** Implement offline fallback and manifest for A2HS ([1ee6166](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/1ee61669cc4f30379ab15e521229166aa966d0e6))
* **pwa:** Implement Service Worker for static asset caching ([ecfb4a0](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/ecfb4a0a3b2a4c478170b63986f4dc92382fa536))

### 🐛 Bug Fixes

* **a11y:** resolve WAI-ARIA and semantic HTML5 violations across templates ([fac6ef9](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fac6ef9a77d43275f8441a209780faef817f41ed))
* **architecture:** Eradicate BEM namespace violations and hardcoded JS DOM hooks ([5c06080](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/5c060800dbf3d2f86b024d8901bd8ab3220b9cb6))
* **architecture:** Eradicate HTML generation from PHP controllers and enforce strict MVC ([5796563](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/579656317a4428f6812b985a924921cc3f159b5d))
* **backend:** Resolve critical Pass-the-Hash vulnerability & enforce strict PSR-7 Response lifecycle ([a7cb246](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/a7cb246ee1dd51197baaa046208c477597c16d08))
* **core:** Eradicate final JS memory leaks, DOM coupling, and SCSS physical pixels ([343c28f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/343c28f2be59903f60f2aad634855a4ea7695ee4))
* **core:** Eradicate final physical pixels, JS memory leaks, and PHP HTML injection ([1b188b2](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/1b188b2a147fae04885e9b40d5a376f508d6b94c))
* **core:** Final audit resolutions for performance, BEM strictness, and fluid typography ([8cfd8e4](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/8cfd8e4317827cc56d0ed297c7c8d860ceaf63dd))
* **core:** Resolve missing HtmlResponse returns and broken JS DOM bindings ([c079d10](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/c079d10a84bcef1c30f4c361d9886ce761a1bc01))
* **core:** Resolve regressions in Chart.js, QR generation, and API responses ([ac75482](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/ac75482401acefb667eaab05126a63847987e180))
* **core:** Resolve strict type errors, linter warnings, and fatal rendering bugs ([5a277e6](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/5a277e68af3e16abf18021b707c7227e1ce1fd65))
* **deploy:** add  --legacy-peer-deps ([1e9621f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/1e9621fd86d3423ceb5f821dc2f69a49f92c3385))
* **frontend:** decouple PermitForm from DOM IDs and enforce strict BEM js-hooks ([fe66a5b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fe66a5b7b77904992493fe34bae40b8b3e428873))
* **frontend:** eradicate remaining ID bindings and enforce global BEM architecture ([830d152](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/830d15261888485022e10d9818a2dad536faf81c))
* **frontend:** Move control bar logic to JS, output requested PHTML files ([bfaf1e3](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/bfaf1e363047bd6e0053026abd02d823a266c29b))
* **frontend:** Move control bar logic to JS, output requested PHTML files ([470e087](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/470e087f963d2f0a94e8ce00368ed81a0a4a9da8))
* **frontend:** Resolve Chart.js canvas collisions, fix QR codes and finalize atomic icons ([cb355d3](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/cb355d3adb36432291c48b7c4f43351d52ccf43f))
* **frontend:** Resolve critical memory leaks and enforce native hidden attribute ([a5e286e](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/a5e286e6a6559cf65f87498e95ff9951418419cc))
* **html:** Finalize atomic icons and ID restoration in admin partials ([43071d1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/43071d1e4441aa95dbc81a9492893040e70e2ad6))
* **html:** Finalize atomic icons and ID restoration in remaining admin partials ([2d7e5d6](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2d7e5d69b3caaf92e30c32a37c5ddf39685369b5))
* **html:** Finalize atomic icons and ID restoration in remaining partials and pages ([5620a41](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/5620a41f4570a0eeef54aa57a711357495ffa79e))
* **html:** Restore ID attributes for semantic structure and accessibility ([c10f96c](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/c10f96c5ac7fbe5f76ca684b52280573e18d86f8))
* **html:** Restore semantic IDs, implement atomic icons, and fix module routing ([fdf1621](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fdf1621ff7c9c69a3583141caca1455babe85b6a))
* **javascript:** Resolve DOM coupling, memory leaks, and A11y in JS modules ([2a3f0de](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2a3f0de46efdeaa502b9ea920afebd896cda16ab))
* **javascript:** Resolve remaining memory leaks and A11y issues ([bdbfdfe](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/bdbfdfecd6b817ed3fd7999226b5846610dbf1f9))
* **js:** decouple CSS values from JS and replace blocking I/O ([e37924d](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e37924d528cd0a780456538a031c888b89fc2ea5))
* **js:** Remove duplicate hooks and prune orphaned dead code ([bdab748](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/bdab7488ffb0136e0b0933619d887e6b732851cb))
* **mvc:** Enforce HtmlResponse on all ViewActions ([8488352](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/848835272874385d87559219dcbf1450778051dc))
* **phtml:** Implement initial WAI-ARIA states and semantic HTML5 structures ([22e8c99](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/22e8c99eb507d47d2e8d97fa8a734d642d7ec884))
* **pwa:** Add secure context guard for Service Worker registration ([2767de8](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2767de806af9c44541a250a6650bef838d58ba11))
* **pwa:** Gracefully handle SecurityError during Service Worker registration ([e023a7f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e023a7fed778aee7b042855c92c35c3082244112))
* **pwa:** Resolve biome linter errors and optimize offline reloading ([480edfe](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/480edfebb82f36065bc33d694dde152c06b9bfe1))
* **scss:** Abstract repeating rem values into dedicated border and radius tokens ([acbe993](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/acbe993fb358a153285f9455a91a39646f228f0b))
* **scss:** Complete logical properties migration and final pixel purge ([f8fdd3e](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/f8fdd3e6ec61e5f7b409c8bc993cb16973c2dde1))
* **scss:** Enforce strict BEM spacing tokens and eliminate hardcoded pixels ([718ae85](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/718ae85ed0fedd2c493facef5db715792136a892))
* **scss:** Purge all remaining hardcoded pixel values completely ([9b12df0](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9b12df0de28b59b78846db7c86d5995b0c05f0b0))
* **scss:** Tokenize layout sizes, opacities, line-heights, and shadows ([624ec10](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/624ec103ece04a7acc6bb8a9986cea7fddff45fc))
* **scss:** Tokenize sizes, font-weights, and color-mix percentages ([b6e47c5](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/b6e47c5eed379603e2000e5ad4d6d65894c01aa9))
* **scss:** Tokenize sizes, font-weights, line-heights, easing, and color-mix percentages ([a468674](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/a468674874f1207c2f82da865b361f79e8597b9a))
* **scss:** Tokenize typography and transition timings for ultimate DRY compliance ([afd25d5](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/afd25d523416bef06cd1a57a3a540b14bc1c3f2e))
* **scss:** Tokenize viewport units, fractions, and relative em scales ([6337738](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/63377380a796f26538035d521ce0daf5650baff5))
* **styles:** Enforce strict token usage and logical properties ([2a4163c](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2a4163ce4a127129ed8a339c751786242d207664))
* **styles:** Eradicate physical pixel values and enforce fluid rem units ([0094804](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/00948045ec040b4bcb6fb77f988adcadc214d765))
* **ui:** Fix invisible QR code modal image by removing conflicting display: none in SCSS ([be75604](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/be75604232577724d0cb04978d7dc5a31d679710))
* **ui:** Implement queue system for Notifier to ensure A11y and CSS transition integrity ([310a249](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/310a24945bfeb66b49f73f7102aa95116bd4c254))
* **ui:** Implement Schwartzian Transform in TableSorter to resolve layout thrashing ([faface7](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/faface7bb4c9ea52802fefc19649889c4f4a107e))
* **ui:** Re-architect QR code rendering to eliminate NS_BINDING_ABORTED double-requests ([fb58854](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fb588546de5d512c7536436b726af201bbe8dd88))
* **ui:** Resolve NS_BINDING_ABORTED error for QR code generation in VoucherManager ([d45af16](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/d45af16f74246dcdc76968a1bf700bcfbe67d6ae))
* **ui:** Resolve UI interaction bugs caused by misaligned JS hooks in PHTML templates ([fed1d41](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fed1d4196c7eefd2694890f15acd265ed5d2f3d4))
* **ui:** Restore tab navigation in users view and fix broken cron copy buttons ([06af50d](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/06af50d5dffea37b34119371a1f7555ac83e7de1))
* **ui:** x Replace remaining emojis with webp icons and implement global lazy loading ([f1bf07a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/f1bf07a6330d69b5bdbc8542d384103475919614))

### ⚙️ Refactoring

* **audit:** admin forms and tools ([6d0d3c2](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/6d0d3c2accce3c6acb055606a0b17093fed9f3aa))
* **audit:** admin table views ([328395f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/328395f5f928577bdef100fd3ac4f5890a3c5f13))
* **audit:** Apply BEM and logical property fixes to Role Matrix and Vouchers ([455240f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/455240f58d1482f323ecb5d4734f71c561567bfb)), references [#voucher-container](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/voucher-container)
* **audit:** Apply logical properties to history and check views, remove inline styles ([48fe98b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/48fe98b6aff004aa7e8f7285b70f19dbc8d9338a))
* **audit:** Apply logical spacing tokens to core views and partials ([311cb12](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/311cb127d03e202781c11016feb7ce957eacd24d))
* **audit:** Apply senior code review feedback to Control Bar & Forms ([9a26626](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9a26626a9d704c359e40d9b98cac63db348163e5))
* **audit:** Apply senior code review feedback to Core & SCSS Architecture ([c2da633](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/c2da6333b3c7f649818a81207c43d6a3f2eba925))
* **audit:** Apply senior code review feedback to Core Components ([95238e3](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/95238e3bacdfd934617e87ceac68d15f110ef7c6))
* **audit:** Apply senior code review feedback to Core UI Components ([2798166](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/27981668363f0b50b3a58fedda40f17208c97467)), references [#000](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/000) [#fff](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/fff) [#6366f1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/6366f1)
* **audit:** Apply senior code review feedback to Forms & Tables ([ac39302](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/ac393020dd8a94a0c2ea117ff263651f9e38762e))
* **audit:** Apply senior code review feedback to Forms and Components ([7d274dd](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/7d274dd192094aaf695e36b06c9391f86fec47dd)), references [#fff](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/fff) [#000](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/000)
* **audit:** Apply senior code review feedback to PHP Controllers & Presenters ([6271301](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/62713016af83a671ad3939428733978c89642bd2))
* **audit:** Apply senior code review feedback to remaining Phase 1 Components ([943874c](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/943874cd8825d29af7285e6f0d67f2c9cbd8df10))
* **audit:** Apply senior code review feedback to remaining SCSS components (Part 3) ([fde7a62](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/fde7a624f5034ef47e6364af6e1ad1acdcf0ac1f))
* **audit:** Apply senior code review feedback to SCSS and PHTML modules ([47665c1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/47665c16db12c35c782809f5561f406ce35e4237))
* **audit:** Apply senior code review feedback to Tabs, Modals & JS Controllers ([e825fb1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e825fb1b6c98bb9d87d873bef636c60db9598728))
* **audit:** Apply senior code review feedback to Tabs, Tables, Toasts & Modals ([d42d40a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/d42d40a7efe9fa68050a0348e2af004a41c1df87))
* **audit:** Apply senior code review feedback to Voucher & Markdown Module ([af112af](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/af112aff6d27f993a5e0a5f897fd7987a85c80b1))
* **audit:** Apply strict BEM classes to PHTML and seal JS memory leaks ([25a3c24](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/25a3c2490cb52c17adcbccba75a3a14c9e08ed74))
* **audit:** BEMIT Scope namespace ([e9ef72b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e9ef72b4a56b7919e4566e6cead838d0f00134e3))
* **audit:** Complete SCSS micro-optimizations and PHTML logical property enforcement (Part 2) ([1e5c7e1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/1e5c7e1d66f0698caa0d7a4d1b0056f8ce6d1251))
* **audit:** Core Layouts and Global UI ([f30f3d7](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/f30f3d771a4843cb799f8fda8b296e1de3c98e4a))
* **audit:** Email Templates and PDF Print Layout ([e14aa56](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e14aa562ae1023f44f6b68733ff1f59c89b10427))
* **audit:** Enforce flat SCSS architecture and fix UI regressions ([9952b23](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9952b23e0f252bbaba696bdd7427160cede04c7d))
* **audit:** Enforce strict BEM constraints across all PHTML templates ([8cdd812](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/8cdd81236c1dea9e40c0947c654586f47d886e5a))
* **audit:** Eradicate inline style hell in generator tools and roles ([29bc61e](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/29bc61e8826d7af112f796243440da4535c52d73)), references [#6366f1](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/6366f1)
* **audit:** Eradicate inline style injection from JavaScript modules ([cc5ac96](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/cc5ac96c8454a1f9cbbb7b28ef74388d55add4f3))
* **audit:** Eradicate inline style injection from JavaScript modules ([21b801f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/21b801ff977c93d0f8082fbddc463d66ce5f5e29))
* **audit:** Eradicate inline table styles and finalize logical spacing in admin tabs ([b874904](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/b87490457c15e9181f3e9902ec6d72f33cb0232e))
* **audit:** Eradicate inline table styles and finalize logical spacing in remaining admin tabs ([acba990](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/acba990fba7699b6c06a03f070bcff2f3eb84d33))
* **audit:** Eradicate magic numbers in SCSS and fix remaining JS physical classes ([9411414](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9411414858920e0d2503ef565d69416e686ef167))
* **audit:** Eradicate remaining physical spacing classes across public views and system tabs ([c489a0f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/c489a0f64de2cc0a67c125760833a032c7221fb1))
* **audit:** Finalize Phase 2 - App event delegation & JS form controllers ([9765d8b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9765d8b03c56699925e76cfd5e3a1f0ad0ffb41a))
* **audit:** Fix Bootstrapper instance collision and enforce BEM base classes ([75e862e](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/75e862e5fbc0759dae0ad7bf44d5cdde68a828fa))
* **audit:** Fix Dart Sass deprecations, resolve missing import and implement DRY pagination ([61d453e](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/61d453ee1173ccdab5d4a2fa2cb9a448d0ac4569))
* **audit:** Fix UI bugs introduced during BEM and layout standardization ([198f56f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/198f56f727bb050b2d7349051ac9c75dbf1d788c))
* **audit:** fixes for Biome linter warnings ([1185631](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/1185631d14e49c65a42231bed49fcd72cae60967))
* **audit:** Form Components ([df1fb3c](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/df1fb3cb178ca81dedadc9b0028588b32154ce89))
* **audit:** Implement MutationObserver for GC and fix remaining SCSS nesting ([431aa5c](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/431aa5c7ab51f794ad19f8e080b688207d1124e6))
* **audit:** Implement Phase 1 of strictly flat BEM/ITCSS architecture ([f8c7459](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/f8c74591fd6455ca0c42effaa80c19d67a9e58e6))
* **audit:** Implement Phase 2 - Form infrastructure & Specificity fixes ([0e2b31a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/0e2b31a0ad01df1093236cdc3c542312eb3a7f88))
* **audit:** Implement Phase 3 - Strict BEM states & decoupled children ([e0e56f0](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/e0e56f09e5ec79fbf7a2bece192e48259247e543))
* **audit:** Implement Phase 4 - ITCSS Utility cleanup and Logical Naming ([da8738a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/da8738a8eb9998dbfc6ba5a9ea74803bd0165b81))
* **audit:** JavaScript DOM manipulation ([a9fdf4a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/a9fdf4a347ff7767cb95de2421b50b90320502ef))
* **audit:** JS Architecture ([8c8d8d4](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/8c8d8d4830611047a3bb5540c1153441afaf8e09))
* **audit:** layout utilities and PHTML ([ba7f3ba](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/ba7f3baf7fa0b319b81e49975bbac37cb20f1a69))
* **audit:** Modal Architecture ([9e95307](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/9e953076f9d0c22a0b945a17d51da8d327d11ed5))
* **audit:** Public Frontend ([8e4d1d7](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/8e4d1d74310823058c6ceef0acd215078e82593e))
* **audit:** Purge hardcoded values and enforce token system in SCSS components ([667144d](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/667144da0c6bd819de935fbaaee107e8d7e3fb8a)), references [#000](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/000) [#1e293b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/1e293b) [#db2777](https://github.com/RaptorXilef/kga-einfahrgenehmigung/issues/db2777)
* **audit:** SCSS architecture ([befa99b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/befa99bd9c3d248992c6239383c6ca1197b9c699))
* **audit:** SCSS Components ([2cfb07d](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2cfb07d842769ba1807fec1abc5c923c0846740c))
* **audit:** Security & Test-Suite (Phase 4) ([741fd3f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/741fd3f8310de1dd86987f8a6bda55a570e5d909))
* **audit:** Stats & Maintenance modules ([b9a0d6a](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/b9a0d6a4bf659194c8bfb5cfe2bbe22e719012e4))
* **audit:** Vitest DOM Coverage ([85bab5b](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/85bab5b6590b889ddd8092c00018b5473c9f2439))
* **audit:** WAI-ARIA and Screenreader Accessibility ([311aedc](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/311aedc95b747843bc19b86c7439f3dd97dfdc72))
* **audit:** Z-Index architecture ([ec4d326](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/ec4d326bc237d7be04f5ac827cf82321bb7d9125))
* **audit:** Z-Index architecture ([2fccd3f](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/2fccd3fa125e985b3f80b8c2759fb1551ed7d8a4))

### 🧪 Tests

* **frontend:** Update Vitest and fix remaining DOM bindings ([0e836b9](https://github.com/RaptorXilef/kga-einfahrgenehmigung/commit/0e836b90be9abda416a9136310f06809bcf9d93c))
